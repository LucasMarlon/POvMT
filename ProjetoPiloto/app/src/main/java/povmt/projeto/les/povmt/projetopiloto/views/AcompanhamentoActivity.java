...
public class AcompanhamentoActivity extends ActionBarActivity {
    ...
    private RelativeLayout acompanhamentoLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acompanhamentoLayout = (RelativeLayout) findViewById(R.id.acompanhamentoLayout);
        mChart = new PieChart(this);
        // add pie chart to main layout
        acompanhamentoLayout.addView(mChart);
        acompanhamentoLayout.setBackgroundColor(Color.parseColor("#55656C"));
